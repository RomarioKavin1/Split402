...
export async function getSplitDetails(
  ...
  // Debug: log argument types
  console.log("[getSplitDetails] conversationId type:", typeof conversationId, conversationId);
  const contract = getContract(provider);
  // Pass conversationId as string, not bytes32
...
export async function getSplitsByConversationId(
  ...
  // Debug: log argument types
  console.log("[getSplitsByConversationId] conversationId type:", typeof conversationId, conversationId);
  const contract = getContract(provider);
  // Pass conversationId as string, not bytes32
